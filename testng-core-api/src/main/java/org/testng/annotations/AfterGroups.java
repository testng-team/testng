...
public @interface AfterGroups {
  ...
  /**
   * The list of groups this class/method belongs to. The list also describes the groups that this
   * configuration method will be run after (if no {@link #value()} attribute is defined).
   *
   * @return the value
   */
   ...
   * declared on the same test class, superclasses included.
   *
   * @return the value (default 0)
   */
