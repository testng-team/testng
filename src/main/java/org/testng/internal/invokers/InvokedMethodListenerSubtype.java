 ...
 * extended invoked method listener. All {@link IInvokedMethodListener}s are considered {@link
 * #SIMPLE_LISTENER}, instances of {@link IInvokedMethodListener2} are all considered {@link
 * #EXTENDED_LISTENER}.
 *
...
enum InvokedMethodListenerSubtype {
  ...
  public static InvokedMethodListenerSubtype fromListener(IInvokedMethodListener listenerInstance) {
    ...
    throw new TestNGException(
        "Illegal "
            + IInvokedMethodListener.class.getSimpleName()
            + " instance: "
