...
public interface ITestResult extends IAttributes, Comparable<ITestResult> {
  ...
  /**
   * @return The test name if this result's related instance implements ITest or use
   * @Test(testName=...), null otherwise.
   */
  String getTestName();
  ...
  /**
   * @param wasRetried - <code>true</code> if the test was retried and <code>false</code>
   * otherwise.
   */
