...
public class XmlMethodSelector {
  ...
  public int hashCode() {
    ...
    if (getScript() != null) {
      result = prime * result + ((getScript().getExpression() == null) ? 0
          : getScript().getExpression().hashCode());
      result = prime * result + ((getScript().getLanguage() == null) ? 0
          : getScript().getLanguage().hashCode());
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!getScript().getExpression()
