...
public interface IJUnitTestRunner {
  ...
  static IJUnitTestRunner createTestRunner(TestRunner runner) {
    ...
    try {
      ...
      Utils
          .log(IJUnitTestRunner.class.getSimpleName(), 2, "JUnit 4 was not found on the classpath");
      try {
        // fallback to JUnit 3
        ...
        Utils.log(IJUnitTestRunner.class.getSimpleName(), 2,
            "JUnit 3 was not found on the classpath");
