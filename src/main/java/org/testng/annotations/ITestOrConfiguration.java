...
public interface ITestOrConfiguration extends IParameterizable {
   ...
   * is guaranteed to have been invoked before this method. Furthermore, if any of these methods was
   ...
   * the methods depended upon will be run, but you are guaranteed that all these methods will be
   * run before the test method that contains this annotation is run. Furthermore, if any of these
