...
public interface IConfigurationAnnotation extends ITestOrConfiguration {
   ...
   * Internal use only.
   *
   * @return true if this configuration annotation is not a "true" configuration annotation but a
   * @BeforeSuite or similar that is represented as a configuration annotation.
   */
