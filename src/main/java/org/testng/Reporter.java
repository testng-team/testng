...
public class Reporter {
  ...
  /**
   * Log the passed string to the HTML reports if the current verbosity is equal or greater than the
   * one passed in parameter. If logToStandardOut is true, the string will also be printed on
   * standard out.
   *
   * @param s The message to log
