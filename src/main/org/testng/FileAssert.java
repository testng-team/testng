...
public class FileAssert {
  ...
  /**
   * @see #assertDirectory(File, String, long expected)
   */
  ...
  /**
   * @see #assertFile(File, String, long expected)
   */
  ...
  /**
   * @see #assertLength(File, String, long expected)
   */
  ...
  /**
   * @see #assertMinLength(File, String, long expected)
   */
  ...
  /**
   * @see #assertMaxLength(File, String, long expected)
   */
