...
public final class GuiceHelperTest {
  ...
  public void getInjector_spiModule_injectorHasModule() {
    MockInjector injector = (MockInjector) guiceHelper
        .getInjector(new MockClass(), new MockInjectorFactory());
  ...
  private static final class MockClass extends ClassImpl {
    ...
    public MockClass() {
      super(new FakeTestContext(), GuiceHelperTest.class, null, (ITest) () -> "GITHUB-2273", null,
          null, null);
    }
  }
}
