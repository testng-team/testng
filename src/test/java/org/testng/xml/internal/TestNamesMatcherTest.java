...
public class TestNamesMatcherTest extends SimpleBaseTest {
    ...
    public void testCloneIfContainsTestsWithNamesMatchingAny() {
        ...
        TestNamesMatcher testNamesMatcher = new TestNamesMatcher(suite, Collections.singletonList("test2"));
    ...
    public void testCloneIfContainsTestsWithNamesMatchingAnyChildSuites(String testname, boolean foundInParent, boolean foundInChildOfChild) {
        ...
        TestNamesMatcher testNamesMatcher = new TestNamesMatcher(parentSuite, Collections.singletonList(testname));
        List<XmlTest> xmlTests = testNamesMatcher.getMatchedTests();
        if (foundInParent) {
