 ...
 * files:
 * <p>
 * - parent-suite-with-duplicate-child -> [child-suite-1, children/child-suite-3, child-suite1,
 ...
 * <p>
 * parent-suite-with-duplicate-child ├───child-suite-1 ├───child-suite-3 │   ├───child-suite-2 │
 * ├───child-suite-4 │   └───child-suite-5 ├───child-suite-1(0) └───child-suite-3(0)
 * ├───child-suite-2(0) ├───child-suite-4(0) └───child-suite-5(0)
 * <p>
 * but NOT like:
 * <p>
 * parent-suite-with-duplicate-child ├───child-suite-1 ├───child-suite-3 ├───child-suite-1(0)
...
public class DuplicateChildSuitesInitializationTest extends SimpleBaseTest {
  ...
  public void checkDuplicateChildSuites() throws IOException {
    String path = getPathToResource(
        "checksuitesinitialization/parent-suite-with-duplicate-child.xml");
