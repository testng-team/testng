...
public class Sample1284 {
  ...
  public void testWithListener() {
    ...
    Assert.assertEquals(Listener1284.testList.get(0),
        Sample1284.class.getName() + " - Before Invocation");
  }
  ...
  public void testWithChildListener() {
    ...
    List<String> expectedList = Lists
        .newArrayList(beforeInvocation, afterInvocation, beforeInvocation);
