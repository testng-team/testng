...
public class IssueTest extends SimpleBaseTest {
  ...
  public void testListenerInvocation(Class<?> clazz, XmlSuite.FailurePolicy policy,
  ...
  public Object[][] getData() {
    List<String> passList = Arrays
        .asList("BeforeInvocation_beforeMethod_STARTED", "AfterInvocation_beforeMethod_SUCCESS",
    ...
    List<String> baseList = Arrays
        .asList("BeforeInvocation_beforeMethod_STARTED", "AfterInvocation_beforeMethod_FAILURE",
