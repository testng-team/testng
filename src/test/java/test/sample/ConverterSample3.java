...
/**
 * Sample file for the Javadoc annotations to Java 5 annotations converter for a non-default
 * package
 *
...
public class ConverterSample3 {
  ...
  /**
   * @testng.test
   * @testng.expected-exceptions value = "java.lang.NullPointerException
   ...
   * @testng.test groups = "groupA" alwaysRun=true dependsOnMethods = "expectedExceptions"
   * timeOut="3000"
