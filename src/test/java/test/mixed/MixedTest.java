...
public class MixedTest extends BaseTest {
  ...
  public void mixedWithExcludedGroups() {
    ...
    Assert.assertEquals(tla.getPassedTests().size(),
        5); //2 from junit3test1, 2 from junit4test1, 0 from testngtest1 (no groups), 1 from testnggroups (1 is included, 1 is excluded)
