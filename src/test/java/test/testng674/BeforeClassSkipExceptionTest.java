...
public class BeforeClassSkipExceptionTest extends SimpleBaseTest {
  ...
  private static void createTestNGInstanceAndRun(ReportingListenerFor674 reporter,
      Class<?>... clazz) {
    createTestNGInstanceAndRun(reporter, 1, false, clazz);
  }

  private static void createTestNGInstanceAndRun(ReportingListenerFor674 reporter,
      int expectedCount, boolean
  ...
  public void testIfTestMethodHasException() {
    ...
    createTestNGInstanceAndRun(reporter,
        TestClassSampleContainer.SampleClassWithFailingBeforeClassMethod.class);
  }
  ...
  public void testExceptionDetailsWhenClassHasMultipleFailures() {
    ReportingListenerFor674 reporter = new ReportingListenerFor674();
    createTestNGInstanceAndRun(reporter,
        TestClassSampleContainer.SampleClassWithMultipleFailures.class);
  }
  ...
  public void testExceptionDetailsWhenClassHasExplicitSkipInConfiguration() {
    ReportingListenerFor674 reporter = new ReportingListenerFor674();
    createTestNGInstanceAndRun(reporter,
        TestClassSampleContainer.SampleClassWithExplicitConfigSkip.class);
  }
  ...
  public void testExceptionDetailsWhenConfigHasAlwaysRun() {
    ReportingListenerFor674 reporter = new ReportingListenerFor674();
    createTestNGInstanceAndRun(reporter,
        TestClassSampleContainer.SampleClassWithMultipleFailuresAndAlwaysRun
            .class);
  }
