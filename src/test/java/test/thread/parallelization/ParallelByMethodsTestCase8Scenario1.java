 ...
 *
 * Test Case Summary: Parallel by methods mode with parallel test suites using factories with data
 * providers but no dependencies.
 *
 ...
 * test classes with factories using data providers with varying numbers of data sets. One suite
 * shall consist of a single test with multiple test classes with factories using data providers
 * with varying numbers of data sets. One suite shall have multiple tests with multiple classes,
 * none of which use a factory.
 *
 ...
 * is specified 11) `group-by-instances is NOT set 12) here are no method exclusions
 */
public class ParallelByMethodsTestCase8Scenario1 extends BaseParallelizationTest {
  ...
  public void sanityCheck() {
    ...
    assertEquals(testMethodLevelEventLogs.size(), 405,
    ...
    assertEquals(suiteOneTestMethodLevelEventLogs.size(), 117,
    ...
    assertEquals(suiteTwoTestMethodLevelEventLogs.size(), 171,
  ...
  public void verifyThatMethodLevelEventsRunInDifferentThreadsFromSuiteAndTestLevelEvents() {
    ...
    verifyEventsForTestMethodsRunInTheSameThread(
        TestClassAFiveMethodsWithFactoryUsingDataProviderAndNoDepsSample.class, SUITE_A,
        SUITE_A_TEST_A);

    verifyEventsForTestMethodsRunInTheSameThread(
        TestClassCSixMethodsWithFactoryUsingDataProviderAndNoDepsSample.class, SUITE_A,
        SUITE_A_TEST_A);
    ...
    verifyEventsForTestMethodsRunInTheSameThread(
        TestClassDThreeMethodsWithFactoryUsingDataProviderAndNoDepsSample.class, SUITE_B,
        SUITE_B_TEST_B);

    verifyEventsForTestMethodsRunInTheSameThread(
        TestClassBFourMethodsWithFactoryUsingDataProviderAndNoDepsSample.class, SUITE_B,
        SUITE_B_TEST_B);

    verifyEventsForTestMethodsRunInTheSameThread(
        TestClassFSixMethodsWithFactoryUsingDataProviderAndNoDepsSample.class, SUITE_B,
        SUITE_B_TEST_B);
