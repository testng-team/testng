 ...
 *
 * Test Case Summary:  Parallel by methods mode with sequential test suites using a factory with a
...
public class ParallelByMethodsTestCase7Scenario2 extends BaseParallelizationTest {
  ...
  public void sanityCheck() {
    ...
    assertEquals(testMethodLevelEventLogs.size(), 297,
    ...
    assertEquals(suiteTwoTestMethodLevelEventLogs.size(), 180,
