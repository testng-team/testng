 ...
 *
 * Test Case Summary: Parallel by methods mode with sequential test suites using a factory which
 ...
 * methods with a factory method using a data provider specifying 3 sets of data.
 *
 ...
 * data set from the data provider. Expectation is that only 15 threads will be spawned at once.
