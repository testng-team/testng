 ...
 *
 * Scenario Description: Two suites with 1 and 2 tests respectively. One test for a suite shall
 * consist of a single test class while the rest shall consist of more than one test class.
 *
 * 1) The suite thread pool is 2, so neither suite should have to wait for the other to complete
...
public class ParallelByMethodsTestCase2Scenario1 extends BaseParallelizationTest {
  ...
  public void sanityCheck() {
    ...
    assertEquals(testMethodLevelEventLogs.size(), 87,
