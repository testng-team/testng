 ...
 * to the number of test methods, ensuring that no method should have to wait for any other method
 * to complete execution 3) There are NO configuration methods 4) All test methods pass 5) NO
  ...
  public void sanityCheck() {
    ...
    assertEquals(testLevelEventLogs.size(), 2,
        "There should be 2 test level events logged for " + SUITE + ": " +
            testLevelEventLogs);
    assertEquals(testMethodLevelEventLogs.size(), 15,
