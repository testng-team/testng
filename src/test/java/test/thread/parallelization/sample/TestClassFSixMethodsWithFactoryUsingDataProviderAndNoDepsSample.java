...
public class TestClassFSixMethodsWithFactoryUsingDataProviderAndNoDepsSample {
    ...
    public TestClassFSixMethodsWithFactoryUsingDataProviderAndNoDepsSample(String suiteName, String testName, String
    ...
    @Test
    public void testMethodF() throws
            InterruptedException {
        long time = System.currentTimeMillis();
    ...
    public static Object[][] dataProvider(ITestContext context) {
        ...
        String classNamePattern = TestClassFSixMethodsWithFactoryUsingDataProviderAndNoDepsSample.class
                .getSimpleName() + "(";
