 ...
 *
 * Test Case Summary: Parallel by methods mode with parallel test suites using a non-parallel data
 * provider but no dependencies and no factories.
 *
 * Scenario Description: Three suites with 1, 2 and 3 tests respectively. One test for a suite shall
 * consist of a single test class while the rest shall consist of more than one test class. Some
 * test classes have a mixture of some methods that use a data provider and some which do not. The
 * data providers provide data sets of varying sizes.
 *
 ...
 * thread count before they can begin execution. The expectation is that a thread for a method does
 * not terminate until the method has been invoked for all sets of data if it uses a data provider.
 * 6) The thread count is more than the number of test methods for the tests in one of the suites,
 * ensuring that none of the methods in that suite should have to wait for any other method to
 * complete execution. The expectation is that a thread for a method does not terminate until the
 * method has been invoked for all sets of data if it uses a data provider. 7) There are NO
...
public class ParallelByMethodsTestCase4Scenario1 extends BaseParallelizationTest {
  ...
  public void setUp() {
    ...
    createXmlTest(suiteTwo, SUITE_B_TEST_A,
    ...
    createXmlTest(suiteThree, SUITE_C_TEST_A,
    ...
    createXmlTest(suiteThree, SUITE_C_TEST_B,
    ...
    createXmlTest(suiteThree, SUITE_C_TEST_C,
  ...
  public void sanityCheck() {
    ...
    assertEquals(suiteOneTestMethodLevelEventLogs.size(), 69,
    ...
    assertEquals(suiteTwoTestMethodLevelEventLogs.size(), 81,
    ...
    assertEquals(suiteThreeTestMethodLevelEventLogs.size(), 270,
  ...
  public void verifyThatTestMethodsRunInParallelThreads() {
    verifyParallelTestMethodsWithNonParallelDataProvider(
        getTestMethodLevelEventLogsForTest(SUITE_A, SUITE_A_TEST_A), SUITE_A_TEST_A,
        expectedInvocationCounts,
        11, 3
    );

    verifyParallelTestMethodsWithNonParallelDataProvider(
        getTestMethodLevelEventLogsForTest(SUITE_B, SUITE_B_TEST_A), SUITE_B_TEST_A,
        expectedInvocationCounts,
        5, 6
    );

    verifyParallelTestMethodsWithNonParallelDataProvider(
        getTestMethodLevelEventLogsForTest(SUITE_B, SUITE_B_TEST_B), SUITE_B_TEST_B,
        expectedInvocationCounts,
        13,
        20
    );
    ...
    verifyParallelTestMethodsWithNonParallelDataProvider(
        getTestMethodLevelEventLogsForTest(SUITE_C, SUITE_C_TEST_A), SUITE_C_TEST_A,
        expectedInvocationCounts,
        12,
        10
    );
    ...
    verifyParallelTestMethodsWithNonParallelDataProvider(
        getTestMethodLevelEventLogsForTest(SUITE_C, SUITE_C_TEST_B), SUITE_C_TEST_B,
        expectedInvocationCounts,
        9,
        5
    );
    ...
    verifyParallelTestMethodsWithNonParallelDataProvider(
        getTestMethodLevelEventLogsForTest(SUITE_C, SUITE_C_TEST_C), SUITE_C_TEST_C,
        expectedInvocationCounts,
        18,
        12
    );
