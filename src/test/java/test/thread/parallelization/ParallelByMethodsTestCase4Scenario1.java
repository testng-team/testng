...
import test.thread.parallelization.sample.TestClassFourMethodsWithDataProviderOnAllMethodsAndNoDepsSample;
...
import test.thread.parallelization.sample.TestClassSixMethodsWithDataProviderOnAllMethodsAndNoDepsSample;
import test.thread.parallelization.sample.TestClassThreeMethodsWithDataProviderOnAllMethodsAndNoDepsSample;
 ...
 *
 * Test Case Summary: Parallel by methods mode with parallel test suites using a non-parallel data provider but no
 *                    dependencies and no factories.
 *
 * Scenario Description: Three suites with 1, 2 and 3 tests respectively. One test for a suite shall consist of a single
 *                       test class while the rest shall consist of more than one test class. Some test classes have a
 *                       mixture of some methods that use a data provider and some which do not. The data providers
 *                       provide data sets of varying sizes.
 *
 ...
 *    have to wait the active thread count to drop below the maximum thread count before they can begin execution. The
 ...
 *    of the methods in that suite should have to wait for any other method to complete execution. The expectation is
 *    that a thread for a method does not terminate until the method has been invoked for all sets of data if it uses a
 *    data provider.
...
public class ParallelByMethodsTestCase4Scenario1 extends BaseParallelizationTest {
    ...
    public void setUp() {
        ...
        createXmlTest(suiteThree, SUITE_C_TEST_A,
                TestClassThreeMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class,
        ...
        createXmlTest(suiteThree, SUITE_C_TEST_B,
                TestClassFourMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class,
        ...
        createXmlTest(suiteThree, SUITE_C_TEST_C,
                ...
                TestClassSixMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class);
        ...
        expectedInvocationCounts.put(
                TestClassThreeMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodA", 3);
        expectedInvocationCounts.put(
                TestClassThreeMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodB", 3);
        ...
        expectedInvocationCounts.put(
                TestClassFiveMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodA", 3);
        expectedInvocationCounts.put(
                TestClassFiveMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodB", 3);
        ...
        expectedInvocationCounts.put(
                TestClassFourMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodA", 2);
        expectedInvocationCounts.put(
                TestClassFourMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodB", 2);
        ...
        expectedInvocationCounts.put(
                TestClassSixMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodA", 3);
        expectedInvocationCounts.put(
                TestClassSixMethodsWithDataProviderOnAllMethodsAndNoDepsSample.class.getCanonicalName() +
                        ".testMethodB", 3);
    ...
    public void sanityCheck() {
        ...
        assertEquals(suiteOneTestMethodLevelEventLogs.size(), 69, "There should be 69 test method level events " +
        ...
        assertEquals(suiteTwoTestMethodLevelEventLogs.size(), 81, "There should be 81 test method level events " +
        ...
        assertEquals(suiteThreeTestMethodLevelEventLogs.size(), 270, "There should be 270 test method level events " +
    ...
    public void verifyThatTestMethodsRunInParallelThreads() {
        ...
        verifyParallelTestMethodsWithNonParallelDataProvider(
                getTestMethodLevelEventLogsForTest(SUITE_C, SUITE_C_TEST_A), SUITE_C_TEST_A, expectedInvocationCounts,
                12,
                10
        );

        verifyParallelTestMethodsWithNonParallelDataProvider(
                getTestMethodLevelEventLogsForTest(SUITE_C, SUITE_C_TEST_B), SUITE_C_TEST_B, expectedInvocationCounts,
                9,
                5
        );

        verifyParallelTestMethodsWithNonParallelDataProvider(
                getTestMethodLevelEventLogsForTest(SUITE_C, SUITE_C_TEST_C), SUITE_C_TEST_C, expectedInvocationCounts,
                18,
                12
        );
    }
