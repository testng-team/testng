...
public class ParallelTestTest extends BaseTest {
  ...
  public void verifyParallel(boolean isCommandLine, XmlSuite.ParallelMode parallelMode,
      int expectedThreadCount) {
    verifyExpected(isCommandLine, parallelMode, expectedThreadCount, Test1Test.class,
        Test2Test.class);
  }

  @Test(dataProvider = "verifyParallelWithFactoryDp") // TODO use "verifyParallelDp"
  public void verifyParallelWithFactory(boolean isCommandLine, XmlSuite.ParallelMode parallelMode,
      int expectedThreadCount) {
    verifyExpected(isCommandLine, parallelMode, expectedThreadCount,
        ParallelWithFactorySampleTest.class);
  }
  ...
  private void verifyExpected(boolean isCommandLine, XmlSuite.ParallelMode parallelMode,
      int expectedThreadCount,
      Class<?>... classes) {
