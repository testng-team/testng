...
public class JUnit4Test extends BaseTest {
  ...
  public static Object[][] dp() {
    return new Object[][]{
        ...
        new Object[]{
            ...
            JUnit4ParameterizedTest.EXPECTED, JUnit4ParameterizedTest.FAILED,
  ...
  public void testTests(Class<?>[] classes, String[] expectedPassedTests,
      String[] expectedFailedTests, String[] expectedSkippedTests) {
    addClasses(classes);
