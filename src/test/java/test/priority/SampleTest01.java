...
public class SampleTest01 extends SampleTestBase {
  ...
  @Test(priority = 2, dependsOnMethods = {"test0010_createAction"})
  ...
  @Test(priority = 4, dependsOnMethods = {"test0010_createAction"})
  public void test0040_viewAction() {
    Assert.assertTrue(true);
  }

  @Test(priority = 5, dependsOnMethods = {"test0010_createAction"})
