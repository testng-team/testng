...
public class EfficientPriorityParallelizationTest extends BaseParallelizationTest {
  ...
  public void setUp() {
    ...
    suiteOneTestOneTestMethodLevelEventLogs = getTestMethodLevelEventLogsForTest(SUITE_A,
        SUITE_A_TEST_A);
    suiteOneTestTwoTestMethodLevelEventLogs = getTestMethodLevelEventLogsForTest(SUITE_A,
        SUITE_A_TEST_B);
    ...
    suiteOneTestTwoListenerOnFinishEventLog = getTestListenerFinishEventLog(SUITE_A,
        SUITE_A_TEST_B);
  }
  ...
  public void sanityCheck() {
    assertEquals(suiteLevelEventLogs.size(), 2,
        "There should be 2 suite level events logged for " + SUITE_A +
            ": " + suiteLevelEventLogs);
    assertEquals(testLevelEventLogs.size(), 4,
        "There should be 4 test level events logged for " + SUITE_A +
            ": " + testLevelEventLogs);
    ...
    assertEquals(suiteOneTestLevelEventLogs.size(), 4,
        "There should be 4 test level events logged for " + SUITE_A +
  ...
  public void verifyTestLevelMethodLevelEventLogsOccurBetweenAfterTestListenerStartAndFinishEventLogs() {
    ...
    verifyEventsOccurBetween(suiteOneTestTwoListenerOnStartEventLog,
