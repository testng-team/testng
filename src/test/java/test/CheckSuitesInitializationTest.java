 ...
 *
 * All paths were being resolved using the initial suite's location and not that of the current
 * suite being parsed/processed.
 *
 * This test checks that TestNG can handle cases where we have the following set of files (all
 * linked using relative paths):
 *
 * - parent-suite -> [child-suite-1, children/child-suite-3] - children/child-suite-3 ->
