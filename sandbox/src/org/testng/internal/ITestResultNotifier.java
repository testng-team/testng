...
public interface ITestResultNotifier {
  ...
  void addPassedConfiguration(ITestNGMethod tm, ITestResult itr);
  
  void addSkippedConfiguration(ITestNGMethod tm, ITestResult itr);
  
  void addFailedConfiguration(ITestNGMethod tm, ITestResult itr);
