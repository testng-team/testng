...
class BaseInvoker {
  ...
  /**
   * Class failures, each mapped to the sequence number {@link ConfigInvoker} gave it. Must be
   * synced as the Invoker is accessed concurrently.
   */
  protected final Map<Class<?>, Map<Object, Long>> m_classInvocationResults =
