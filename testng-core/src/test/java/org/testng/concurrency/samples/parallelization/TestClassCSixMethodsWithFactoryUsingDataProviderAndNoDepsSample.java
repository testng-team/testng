...
public class TestClassCSixMethodsWithFactoryUsingDataProviderAndNoDepsSample {
  ...
  public TestClassCSixMethodsWithFactoryUsingDataProviderAndNoDepsSample(
      String suiteName, String testName, String sleepFor, String dpVal) {
  ...
  @Test
  public void testMethodE() throws InterruptedException {
    long time = System.currentTimeMillis();
  ...
  @Test
  public void testMethodF() throws InterruptedException {
    long time = System.currentTimeMillis();
  ...
  public static Object[][] dataProvider(ITestContext context) {
    ...
    if (dataProviderParam.contains(classNamePattern)) {
      dataProviderParam =
          dataProviderParam.substring(
              dataProviderParam.indexOf(classNamePattern) + classNamePattern.length());
