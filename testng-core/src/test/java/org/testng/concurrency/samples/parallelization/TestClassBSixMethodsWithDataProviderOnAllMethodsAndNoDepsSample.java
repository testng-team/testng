...
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.EventInfo.DATA_PROVIDER_PARAM;
...
public class TestClassBSixMethodsWithDataProviderOnAllMethodsAndNoDepsSample {
  ...
  public void testMethodA(String suiteName, String testName, String sleepFor, String dpVal)
  ...
  @Test(dataProvider = "data-provider")
  public void testMethodB(String suiteName, String testName, String sleepFor, String dpVal)
      throws InterruptedException {
    long time = System.currentTimeMillis();
  ...
  @Test(dataProvider = "data-provider")
  public void testMethodC(String suiteName, String testName, String sleepFor, String dpVal)
      throws InterruptedException {
    long time = System.currentTimeMillis();
  ...
  @Test(dataProvider = "data-provider")
  public void testMethodD(String suiteName, String testName, String sleepFor, String dpVal)
      throws InterruptedException {
    long time = System.currentTimeMillis();
  ...
  @Test(dataProvider = "data-provider")
  public void testMethodE(String suiteName, String testName, String sleepFor, String dpVal)
      throws InterruptedException {
    long time = System.currentTimeMillis();
  ...
  @Test(dataProvider = "data-provider")
  public void testMethodF(String suiteName, String testName, String sleepFor, String dpVal)
      throws InterruptedException {
    long time = System.currentTimeMillis();
