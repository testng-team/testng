...
import org.testng.concurrency.samples.BaseThreadTest;
import org.testng.concurrency.samples.TrueParallelSampleTest;
...
public class TrueParallelTest extends SimpleBaseTest {
  ...
  public void shouldRunInParallel() {
    ...
    assertThat(success).withFailMessage("Couldn't find any interleaved test method run").isTrue();
  }
