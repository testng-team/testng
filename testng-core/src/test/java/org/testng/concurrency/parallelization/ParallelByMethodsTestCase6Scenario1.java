package org.testng.concurrency.parallelization;

import static org.assertj.core.api.Assertions.assertThat;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getAllSuiteLevelEventLogs;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getAllSuiteListenerStartEventLogs;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getAllTestLevelEventLogs;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getAllTestMethodLevelEventLogs;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getSuiteAndTestLevelEventLogsForSuite;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getSuiteLevelEventLogsForSuite;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getSuiteListenerFinishEventLog;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getSuiteListenerStartEventLog;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getTestLevelEventLogsForSuite;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getTestLevelEventLogsForTest;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getTestListenerFinishEventLog;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getTestListenerStartEventLog;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getTestMethodLevelEventLogsForSuite;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.getTestMethodLevelEventLogsForTest;
import static org.testng.concurrency.samples.parallelization.TestNgRunStateTracker.reset;
...
import org.testng.concurrency.samples.parallelization.BaseParallelizationTest;
import org.testng.concurrency.samples.parallelization.FactoryForTestClassAFiveMethodsWithNoDepsTwoInstancesSample;
import org.testng.concurrency.samples.parallelization.FactoryForTestClassBFourMethodsWithNoDepsFiveInstancesSample;
import org.testng.concurrency.samples.parallelization.FactoryForTestClassCSixMethodsWithNoDepsThreeInstancesSample;
import org.testng.concurrency.samples.parallelization.FactoryForTestClassDThreeMethodsWithNoDepsFourInstancesSample;
import org.testng.concurrency.samples.parallelization.FactoryForTestClassFSixMethodsWithNoDepsSixInstancesSample;
import org.testng.concurrency.samples.parallelization.TestClassAFiveMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassBFourMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassCSixMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassDThreeMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassEFiveMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassFSixMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassGThreeMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassHFourMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassIFiveMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassJFourMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassKFiveMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassLThreeMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassMFourMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassNFiveMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestClassOSixMethodsWithNoDepsSample;
import org.testng.concurrency.samples.parallelization.TestNgRunStateListener;
...
public class ParallelByMethodsTestCase6Scenario1 extends BaseParallelizationTest {
  ...
  public void sanityCheck() {
    ...
    assertThat(suiteThreeSuiteLevelEventLogs.size())
        .withFailMessage(
            "There should be 2 suite level events logged for "
                + SUITE_C
                + ": "
        ...
        .isEqualTo(2);
    assertThat(suiteThreeTestLevelEventLogs.size())
        .withFailMessage(
        ...
        .isEqualTo(6);
    assertThat(suiteThreeTestMethodLevelEventLogs.size())
        .withFailMessage(
