...
import org.testng.concurrency.samples.issue2019.TestClassSample;
import org.testng.concurrency.samples.issue3028.AnotherDataDrivenTestSample;
import org.testng.concurrency.samples.issue3028.DataDrivenTestSample;
import org.testng.concurrency.samples.issue3028.FactoryPoweredDataDrivenTestSample;
import org.testng.concurrency.samples.issue3179.DummyMethodInterceptor;
import org.testng.concurrency.samples.issue3179.SampleSuiteAlteringListener;
...
public class SharedThreadPoolTest extends SimpleBaseTest {
  ...
  public void ensurePriorityAgnosticInterceptorsDontCauseExceptions() {
    TestNG testng = create(org.testng.concurrency.samples.issue3179.TestClassSample.class);
