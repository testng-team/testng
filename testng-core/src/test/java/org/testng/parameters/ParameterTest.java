...
import org.testng.parameters.samples.BeforeWithParameterSample;
import org.testng.parameters.samples.EnumParameterSample;
import org.testng.parameters.samples.Issue1061Sample;
import org.testng.parameters.samples.Issue1554TestClassSample;
...
public class ParameterTest extends SimpleBaseTest {
  ...
  public void testNativeInjection() {
    ...
    String[] expectedMsgs =
        new String[] {
          "Method org.testng.parameters.samples.Issue1061Sample.test() didn't finish within the time-out 1000",
          "Method org.testng.parameters.samples.Issue1061Sample.test() didn't finish within the time-out 3000"
        };
