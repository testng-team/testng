package org.testng.configuration.issue2663;
...
import org.testng.configuration.samples.issue2663.ClassConfigSample;
import org.testng.configuration.samples.issue2663.CrossClassAlphaSample;
import org.testng.configuration.samples.issue2663.CrossClassBravoSample;
import org.testng.configuration.samples.issue2663.DependsOnGroupsSample;
import org.testng.configuration.samples.issue2663.DependsOnMethodsSample;
import org.testng.configuration.samples.issue2663.EqualPrioritySample;
import org.testng.configuration.samples.issue2663.FirstTestSuiteConfigSample;
import org.testng.configuration.samples.issue2663.GroupsConfigSample;
import org.testng.configuration.samples.issue2663.InheritanceChildSample;
import org.testng.configuration.samples.issue2663.LifecycleChildSample;
import org.testng.configuration.samples.issue2663.NoPrioritySample;
import org.testng.configuration.samples.issue2663.ParallelBeforeMethodSample;
import org.testng.configuration.samples.issue2663.ParallelSampleOne;
import org.testng.configuration.samples.issue2663.ParallelSampleTwo;
import org.testng.configuration.samples.issue2663.SameClassSample;
import org.testng.configuration.samples.issue2663.SecondTestSuiteConfigSample;
import org.testng.configuration.samples.issue2663.SuiteConfigSample;
import org.testng.configuration.samples.issue2663.TestConfigSample;
...
public class IssueTest extends SimpleBaseTest {
  ...
  public void priorityDoesNotDependOnTheMethodOrderingSetting(String ordering)
    ...
    try {
      ...
      // Without the priority, "none" keeps the order in which TestNG finds the methods. That order
      // comes from a hash that includes the package name, so a move can make the run above pass
      // without the priority. Sort the methods from every starting order as well.
      for (List<String> startingOrder :
          ConfigurationOrder.allOrdersOf(List.of("alphaBefore", "bravoBefore"))) {
        assertThat(ConfigurationOrder.sortedFrom(SameClassSample.class, startingOrder))
            .describedAs("testng.order=%s, found as %s", ordering, startingOrder)
            .containsExactly("bravoBefore", "alphaBefore");
      }
    } finally {
      if (previous == null) {
