...
import org.testng.configuration.samples.ConfigurationTestSample;
import org.testng.configuration.samples.ExternalConfigurationClassSample;
import org.testng.configuration.samples.MethodCallOrderTestSample;
import org.testng.configuration.samples.SuiteTestSample;
import org.testng.configuration.samples.issue2726.TestClassSample;
import org.testng.configuration.samples.issue2743.SuiteRunnerIssueTestSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlyInvocationSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlyParallelDpFailingSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlyParallelDpSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlyParallelFailingSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlyParallelSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlySequentialDpSample;
import org.testng.configuration.samples.issue3358.ChildFirstTimeOnlyWithLastTimeSample;
...
public class ConfigurationTest extends ConfigurationBaseTest {
  ...
  public void ensureGroupInheritanceWorksForConfigMethods() {
    TestNG testng = create(org.testng.configuration.samples.issue3003.TestClassSample.class);
    testng.setVerbose(2);
    testng.run();
    List<String> expected =
        Arrays.asList("setupMethod1", "setupMethod2", "setupMethod3", "testMethod1");
    assertThat(org.testng.configuration.samples.issue3003.TestClassSample.logs)
        .containsAll(expected);
  }

  @Test(description = "GITHUB-3006")
  public void ensureNativelyInjectedTestResultForAfterMethodMatchesTestMethod() {
    TestNG testng = create(org.testng.configuration.samples.issue3006.TestClassSample.class);
    testng.run();
    ITestResult actual = org.testng.configuration.samples.issue3006.TestClassSample.iTestResult;
    ...
    assertThat(skippedDueTo)
        .containsExactly("org.testng.configuration.samples.issue3006.TestClassSample.beforeMethod");
  }
}
