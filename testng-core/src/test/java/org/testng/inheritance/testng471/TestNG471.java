package org.testng.inheritance.testng471;

import static org.assertj.core.api.Assertions.assertThat;

import org.testng.TestNG;
import org.testng.annotations.Test;
import org.testng.inheritance.samples.testng471.Class1;
import org.testng.inheritance.samples.testng471.Class2;
import org.testng.inheritance.samples.testng471.Class3;
  ...
  public void test_classes_should_not_be_skipped_when_a_after_method_fails() {
    ...
    assertThat(listener.getSucceedMethodNames())
        .containsExactly(
            ...
            "beforeClass1",
            "beforeMethodClass1",
            "test1_1", // "afterMethodClass1" failed
