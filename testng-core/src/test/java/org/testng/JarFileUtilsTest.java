...
public class JarFileUtilsTest {
    ...
    @Test(expectedExceptions = TestNGException.class, expectedExceptionsMessageRegExp = "\nThe test\\(s\\) <\\[testng-tests-child11\\]> cannot be found in suite.", description = "GITHUB-2897: Backward compatibility: Exception thrown if emtpy test names are given and ignoreMissedTestNames are DISABLED by default.")
    ...
    public void testWithEmptyTestNamesAndIgnoreMissedTestNamesEnabled() throws MalformedURLException {
        ...
        JarFileUtils utils = newJarFileUtils(Collections.singletonList(""), ignoreMissedTestNames);
        runTest(
                utils,
                3,
                1,
    ...
    public void testWithAllInvalidTestNamesNoExceptionIfIgnoreMissedTestNamesEnabled()
        ...
        boolean ignoreMissedTestNames = true;
        JarFileUtils utils = newJarFileUtils(Collections.singletonList("testng-tests-child11"), ignoreMissedTestNames);
        runTest(utils, 1, null, null, "Jar suite");
    }

    @Test(description = "GITHUB-2897, No TestNGException thrown when ignoreMissedTestNames enabled and partial given test names are invalid and partial valid test names are expected to run.")
    public void testWithPartialInvalidTestNamesNoExceptionIfIgnoreMissedTestNamesEnabled()
            throws MalformedURLException {
        String[] expectedTestNames = new String[] { "testng-tests-child2", "testng-tests-child4",
                "testng-tests-child5" };
    ...
    public void testWithInvalidXmlFile() throws MalformedURLException {
        JarFileUtils utils = newJarFileUtils(
    ...
    public void ensureThatExceptionAreNotThrown() throws MalformedURLException {
        ...
        List<String> testNames = Arrays.asList("testng-tests-child2", "testng-tests-child4", "testng-tests-child5");
    ...
    private static JarFileUtils newJarFileUtils(List<String> testNames, boolean ignoreMissedTestNames)
            throws MalformedURLException {
