package org.testng.factory.lazy;
...
import org.testng.factory.samples.lazy.AnnotationLazyFalseSample;
import org.testng.factory.samples.lazy.AnnotationLazyTrueSample;
...
public class LazyFactoryResolutionMatrixTest extends SimpleBaseTest {
  ...
  @Test(dataProvider = "combinations", description = "GITHUB-3344")
