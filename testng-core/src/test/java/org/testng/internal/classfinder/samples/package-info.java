/**
 * Input for the tests in {@code org.testng.internal.classfinder}: classes handed to a
 * programmatically built TestNG run so the test can assert on what happened.
 *
 ...
 */
package org.testng.internal.classfinder.samples;
