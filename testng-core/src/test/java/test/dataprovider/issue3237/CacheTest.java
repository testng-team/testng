...
public class CacheTest {
  ...
  public void testMethod(String uuid) {
    ...
    // If bug exists: DP runs (updates currentUuid), but Test receives OLD uuid. Expect failure.
    // If fixed: DP runs (updates currentUuid), Test receives NEW uuid. Expect pass.
