...
public class TimeOutIntegrationTest extends SimpleBaseTest {
  ...
  public void testTimeOutWhenParallelIsTest() {
    ...
    //
    // This guards the GITHUB-811 enforcement only. Both dispatch paths cut the method short at
    // about 1s, so no bound here can tell them apart, and this assertion stays green whichever one
    // parallel="tests" is routed to.
